...
public class NZElectorateMap : MonoBehaviour
{
    ...
    List<string> aucklandElectorates = new List<string>
        {
    ...
    void Start()
    {
        ...
        foreach (Transform electorateObject in electorateMap.transform)
        {
            ...
            if (electorateObject.GetComponent<MeshCollider>() == null)
            {
                ...
                electorateObject.AddComponent<ElectorateController>();
    ...
    private void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                string electorateName = hit.collider.gameObject.name;

                Debug.Log(electorateName);
            }
        }
    }
}